...
const HLEFunction SysMemForKernel[] = {
	...
	{ 0x7B749390, nullptr,                                      "sceKernelFreeHeapMemory",               '?', "" },
	//{ 0xEB7A74DB, &WrapI_IIU<sceKernelAllocHeapMemoryWithOption>, "sceKernelAllocHeapMemoryWithOption",  'x', "iix",        HLE_KERNEL_SYSCALL },
	{ 0xEB7A74DB, nullptr,                                      "sceKernelAllocHeapMemoryWithOption",    'x', "iix",        HLE_KERNEL_SYSCALL },
};
